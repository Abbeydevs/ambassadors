            ...
            <div className="rounded-3xl bg-slate-950 p-8 lg:p-16 text-center space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link
                  ...
                  className="cursor-pointer group px-8 py-4 bg-linear-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-semibold rounded-xl transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/50 flex items-center gap-2 w-full sm:w-auto justify-center"
                >
                  Browse Talents
                ...
                <Link
                  href="/contact"
                  className="px-8 py-4 bg-white/5 hover:bg-white/10 text-white font-semibold rounded-xl border border-white/20 backdrop-blur-sm transition-all duration-300 hover:border-white/40 flex items-center gap-2 w-full sm:w-auto justify-center"
                >
